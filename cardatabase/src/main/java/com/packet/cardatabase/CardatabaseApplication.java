...
public class CardatabaseApplication implements CommandLineRunner {
	...
	public void run(String...args) throws Exception{
		...
		//사용자 이름: user, 암호: user
		urepository.save(new User("user", "$2y$04$InS7aFzeXYhRMCH7S840kOtQHicpoAKJDdjuaKUua6PtrtNf1ITHO", "USER"));
		
		//사용자 이름: admin, 암호: admin
		urepository.save(new User("admin", "$2y$04$kr1TyJCTG3ah1ZHcAkDGjuCD35pZ0IlLhVoUHIuaPVN7skmqL6Ysq", "ADMIN"));
